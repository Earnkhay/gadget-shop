  ...
  <div id="app">
    ...
    <div class="container p-5">
      <div class="row align-items-center">
        ...
        <div class="col">
          <img
            src="../assets/undraw_Profile_re_4a55.png"
            alt=""
            class="img-fluid"
          />
        </div>
      ...
      <div class="container">
        <div class="mb-3">
          <button
            ...
            class="btn me-2"
            :class="[
              profileDisplay == false ? 'btn-transparent' : 'btn-primary',
            ]"
            @click="profileDisplay = true"
          >
            Profile
          </button>
          <button
            ...
            class="btn"
            :class="[
              profileDisplay == true ? 'btn-transparent' : 'btn-primary ',
            ]"
            @click="profileDisplay = false"
          >
            Account settings
          </button>
        </div>
        ...
        <form action="" v-else>
          ...
          <div class="mb-3">
            ...
            <img
              :src="photoURL"
              style="width: 5rem; height: 30%"
              alt="preview image"
            /><span
              class="p-1 delete-img"
...
export default class profile extends Vue {
  ...
  async uploadImage() {
    ...
    const file = (
      document.getElementById("imageInput") as HTMLInputElement | any
    ).files[0];
